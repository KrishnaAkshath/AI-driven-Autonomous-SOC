...
st.set_page_config(page_title="Attack Simulation | SOC", page_icon="🎯", layout="wide")
...
st.warning("⚠️ **Educational Purpose Only** - These simulations demonstrate how the SOC detects and responds to threats")
...
attack_types = {
    ...
    "Port Scan": {
        ...
        "risk": 72,
        "steps": [
            ("Attacker IP: 45.123.67.89 (Russia)", "info"),
    ...
    "Brute Force": {
        ...
        "steps": [
            ...
            ("Attacker: 185.220.101.45 (Tor Exit)", "warning"),
...
st.markdown("---")
st.markdown('<div style="text-align: center; color: #8B95A5; padding: 1rem;"><p style="margin: 0;">🛡️ AI-Driven Autonomous SOC | Attack Simulation Lab</p></div>', unsafe_allow_html=True)
